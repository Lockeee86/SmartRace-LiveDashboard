...
def init_db():
    ...
    _add_column_if_missing('sr_tracks', 'min_laptime_ms', 'INTEGER')
    _add_column_if_missing('sr_tracks', 'max_laptime_ms', 'INTEGER')
    _add_column_if_missing('sr_laps', 'is_outlier', 'BOOLEAN DEFAULT FALSE')
